...
//    wps1.push_back(wp2.setWayPoints(4,19,false,true,10,0,25,NAN,pole2enu_x(sqrt((MY_TARGET_RADIUS + 75.0) * (MY_TARGET_RADIUS + 75.0) + 25.0 * 25.0),MY_TARGET_THETA + atan(25.0 / (MY_TARGET_RADIUS + 75.0))),pole2enu_y(sqrt((MY_TARGET_RADIUS + 75.0) * (MY_TARGET_RADIUS + 75.0) + 25.0 * 25.0),MY_TARGET_THETA + atan(25.0 / (MY_TARGET_RADIUS + 75.0))),20));
