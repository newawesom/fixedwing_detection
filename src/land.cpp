...
void land_wpSet(Modes* m)
{
    ...
    wps.push_back(wp0.setWayPoints(4,16,false,true,0.0,0.0,0.0,NAN,pole2enu_x(0.5 * MY_TARGET_RADIUS, MY_TARGET_THETA),pole2enu_y(0.5 * MY_TARGET_RADIUS, MY_TARGET_THETA),5));
